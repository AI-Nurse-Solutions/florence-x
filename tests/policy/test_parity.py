...
CASES = [
    ({'action_type': 'retrieve', 'data_classification': 'internal'}, "allow_with_constraints", "green"),
    ({'action_type': 'draft', 'data_classification': 'phi_local'}, "require_human", "yellow"),
    ({
        'action_type': 'write_record',
        'data_classification': 'phi_local',
        'reversible': False,
    }, "require_human", "red"),
    ({'action_type': 'send_message', 'external_boundary_crossed': True}, "require_human", "red"),
    ({'action_type': 'call_api', 'external_boundary_crossed': True}, "require_human", "orange"),
    ({'action_type': 'execute_code', 'action_id': 'run-on-prod', 'reversible': False}, "deny", "red_blocked"),
    ({'action_type': 'retrieve', 'data_classification': 'restricted'}, "deny", "red_blocked"),
]
